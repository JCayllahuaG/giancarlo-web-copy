<script setup>
import { ArrowRightEndOnRectangleIcon, BriefcaseIcon, BuildingOffice2Icon, UserIcon, UsersIcon } from '@heroicons/vue/24/solid'
           ...
           <div class="header">
            ...
            <ul class="menu">
                ...
                <li>
                    ...
                    <span v-if="props.isExpanded">Services</span>
                </li>
                <li>
...
li{
    @apply flex flex-row w-full h-10 items-center justify-center space-x-5;
}
.icon-style{
...
.menu{
    @apply flex flex-col items-center h-full p-3 space-y-6;
}
.menu span{
    visibility: hidden;
...
.logout-section{
    @apply flex flex-row px-3 py-5 h-20 w-full items-center justify-center text-white space-x-5;
}
.logout-section span{
    visibility: hidden;
